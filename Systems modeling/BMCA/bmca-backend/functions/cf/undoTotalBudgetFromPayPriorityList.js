// functions/cf/undoTotalBudgetFromPayPriorityList.js
...
// Same origin resolver as in applyTotalBudgetFromPayPriorityList
  ...
  .https.onCall(async (data, context) => {
    ...
    try {
      ...
      for (const doc of ppSnap.docs) {
        ...
        // 1️⃣ Find most recent OAAA delta
        ...
        await db.runTransaction(async (tx) => {
          ...
          const undoDeltaData = {
            ...
            // NEW FIELD
            actionName: 'all accounts total allocation payment',
      ...
      console.error('undoTotalBudgetFromPayPriorityList error:', err);
      throw new functions.https.HttpsError(
        'internal',
        'Failed to undo total budget allocations.'
      );
    }
  });
